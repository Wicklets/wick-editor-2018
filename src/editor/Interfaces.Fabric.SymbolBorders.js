...
var FabricSymbolBorders = function (wickEditor, fabricInterface) {
    ...
    canvas.on('after:render', function() {
        ...
        canvas.forEachObject(function(obj) {
            ...
            if(selectedObjs.indexOf(wickObj) !== -1) return
            if(boxAnimationActive && boxAnimationObj !== wickObj) return;
            if(!wickObj.scriptError) return;
            ...
            /*if(!wickObj.isSymbol) {
                ...
                canvas.contextContainer.lineWidth = 3;
                canvas.contextContainer.globalAlpha = 0.5;
            ...
            var borderOffset = 3;
            boundStart.left += borderOffset;
            boundStart.top += borderOffset;
            boundStart.width -= borderOffset*2;
            boundStart.height -= borderOffset*2;
