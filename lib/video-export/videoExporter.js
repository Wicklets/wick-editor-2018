var VideoExporter = function () {
    ...
    //  args.quality,                 type: Number (lower value = better quality, 15-25 is good)
    //  args.pixel_format,            type: String
    //  args.output_filename,         type: String
    //  args.callback                 type: Function
    this.renderVideoFromFrames = function (args) {
        // Quality flag (-crf) currently disabled because ffmpeg.js wasn't built with that option
        // https://mail-archives.apache.org/mod_mbox/openmeetings-user/201404.mbox/%3CCAJmbs8jB0TDTJL32je6txYiNDVuLfCFLTjHUKazSzhHE7jC7JA@mail.gmail.com%3E
        ...
        var commandFormat = '-r <FRAMERATE> -f image2 -s <WIDTH>x<HEIGHT> -i pic%12d.jpg -vcodec mpeg4 -vb 20M <OUTPUT_FILENAME>';
        ...
        var output_filename = args.output_filename || 'test.mp4';
