...
var fontsAlreadyLoaded = {}
function loadGoogleFont (fontName) {
  if(!fontsAlreadyLoaded[fontName]) {
    console.log('load font: ' + fontName)
    var urlFontName = fontName.replace(' ', '+');
    var fontURL = 'https://fonts.googleapis.com/css?family=' + urlFontName + '" rel="stylesheet">';
    var fontImportTag = '<link href="' + fontURL + '" rel="stylesheet">'
    //document.head.innerHTML += fontImportTag;
    $('head').append(fontImportTag);
    fontsAlreadyLoaded[fontName] = true;
  }
}
