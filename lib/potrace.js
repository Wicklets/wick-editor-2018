...
var Potrace = (function() {
  ...
  function loadBm() {
    ...
    for (i = 0, j = 0; i < l; i += 4, j++) {
      ...
      // zrispo - transparency lower that a certain threshold should set color to 0.
      var alphaThreshold = 150;
      if(imgdataobj.data[i+3] < alphaThreshold) {
        bm.data[j] = 0;
      }
    }
    console.log("set isReady true")
    info.isReady = true;
  }
