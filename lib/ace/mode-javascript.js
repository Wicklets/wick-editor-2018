...
var JavaScriptHighlightRules = function(options) {
    var keywordMapper = this.createKeywordMapper({
        "variable.language":
            ...
            "play|stop|gotoAndPlay|gotoAndStop|gotoNextFrame|gotoPrevFrame|hitTest|copy|moveUp|moveDown|moveLeft|moveRight|rotateCW|rotateCCW|scale|scaleWidth|scaleHeight|flipHorizontal|flipVertical|setOpacity|"    + // Wick function calls
            "JSON|Math|"                                                               + // Other
